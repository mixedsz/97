...
Config.Locations = {
    -- PILLBOX AMMUNATION (Main Store)
    {
        ...
        availableParts = {'pistol_parts', 'smg_parts', 'rifle_parts', 'weapon_attachments'},
    ...
    -- SANDY SHORES AMMUNATION
    {
        ...
        availableParts = {'pistol_parts', 'shotgun_parts', 'weapon_attachments'},
...
-- Weapon Parts (for crafting weapons)
Config.WeaponParts = {
    {
        name = 'Gun Powder',
        item = 'gunpowder',
        price = 0, -- Price for employees
        time = 5000, -- 5 seconds to grab
        label = 'pistol_parts'
    },
    {
        name = 'Screws',
